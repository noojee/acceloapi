...
public class ContractPeriod_ 
{
	...
	public static FilterField<ContractPeriod, Integer> service_item_id = new FilterField<>("service_item_id"); 
	public static FilterField<ContractPeriod, Integer> contract_id = new FilterField<>("contract_id"); 
	...
	public static FilterField<ContractPeriod, Integer> rate_id = new FilterField<>("rate_id"); 
